function [allData, scenario, sensor] = secondScenario()
...
% Generated on: 23-May-2022 19:59:19
...
hPanel2 = uipanel(hFigure,'Units','Normalized','Position',[1/2 1/2 1/2 1/2],'Title','Chase Plot');
% hPanel3 = uipanel(hFigure,'Units','Normalized','Position',[1/2 1/2 1/2 1/2],'Title','Bird''s-Eye Plot');
hPanel4 = uipanel(hFigure,'Units','Normalized','Position',[1/4 0 1/2 1/2],'Title','Radar Periodogram');
...
%     % for the bird plot
%     plotTrack(fastTrackPlotter, poses.Position, poses.Velocity);
...
%     plotOutline(egoOutlinePlotter, position, yaw, length, width, 'OriginOffset', originOffset, 'Color', color);
    ...
    if isValidTime
        ...
        im = imagesc(linspace(((Nfftm/2-1)*c)/(2*fc*deltaT*Nfftm),-c/(4*fc*deltaT),Nfftm) , linspace(0,((150)*c)/(2*df*Nfftn),Nfftn) , shifted_per(1:150,:) , 'Parent',hAxes4);
        colorbar(hAxes4);
